...
class TransactionsPage {
  ...
  removeAccount() {
    if (this.lastOptions) {
      if ( confirm('Вы деиствительно хотите удалить счет?')) {
  ...
  removeTransaction( id ) {
    if (confirm("Вы деиствительно хотите удалить эту транзакцию?")) {
   ...
   * */
  formatDate( date ) {
    const dateTime = new Date(date).toLocaleString('ru', {
      year: 'numeric',
      month: 'long',
      day: 'numeric',
      hour: 'numeric',
